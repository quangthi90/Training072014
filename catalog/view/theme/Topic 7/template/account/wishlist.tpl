      ...
      <tbody id="wishlist-row<?php echo $product['product_id']; ?>">
        <tr>
          ...
          <td class="price"><?php if ($product['price']) { ?>
            ...
            <?php } ?></td>
          <td class="action"><a onclick="addToCart('<?php echo $product['product_id']; ?>');" title="<?php echo $button_cart; ?>" class="cart-bt"><?php echo $button_cart; ?></a><br><a href="<?php echo $product['remove']; ?>"><?php echo $button_remove; ?></a>
          <!---img src="catalog/view/theme/default/image/cart-add.png" alt="<?php echo $button_cart; ?>" title="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" />&nbsp;&nbsp;<a href="<?php echo $product['remove']; ?>"><img src="catalog/view/theme/default/image/remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a--></td>
        </tr>
      </tbody>
      <?php } ?>
    </table>
